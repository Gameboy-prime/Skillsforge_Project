...
public class TutorialCloneMultiplier : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Instruction Block"))
        {
            ...
            Debug.Log("has entered the instruction block");
            string determinant = other.GetComponent<TutorialMultiplier>().multiplierState;
    ...
    public void Dying()
    {
        ...
        king.GetComponent<TutorialFightDetect>().enabled = false;
